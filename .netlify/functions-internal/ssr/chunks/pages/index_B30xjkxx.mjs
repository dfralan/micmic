import { c as $$ButtonAccess, d as $$ButtonAccessSecondary, $ as $$Container, S as SITE_TITLE, a as SITE_DESCRIPTION, b as $$Layout, e as $$Logo } from './404_DRNyU7Bb.mjs';
...
Digitalizá tu negocio. Creá tu catálogo de productos y generá más y mejores ventas.
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": SITE_TITLE, "description": SITE_DESCRIPTION, "image": "https://micmic.shop/img/link-img.jpg", "meta": [] }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main> ${renderComponent($$result2, "Load", $$Load, {})} </main> ` })}`;
